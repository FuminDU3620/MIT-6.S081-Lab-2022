...
main(int argc, char *argv[])
{
  ...
  32:	7f258593          	addi	a1,a1,2034 # 820 <malloc+0x118>
  36:	4505                	li	a0,1
  38:	00000097          	auipc	ra,0x0
  3c:	5e4080e7          	jalr	1508(ra) # 61c <fprintf>
        sleep(atoi(argv[1]));
  40:	6488                	ld	a0,8(s1)
  42:	00000097          	auipc	ra,0x0
  46:	190080e7          	jalr	400(ra) # 1d2 <atoi>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ba:	49a50513          	addi	a0,a0,1178 # 850 <digits>
 3be:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5c6:	28690913          	addi	s2,s2,646 # 848 <malloc+0x140>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 792:	0ca73d23          	sd	a0,218(a4) # 868 <freep>
      return (void*)(p + 1);
